...
### Status
- 2/12/14: We have data! (see below) I'm starting to spec out project tasks over on [the Issues page](https://github.com/openoakland/soft-story-buildings/issues).
